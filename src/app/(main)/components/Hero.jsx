      ...
      <div className="min-h-[40rem] flex flex-col md:flex-row items-center justify-between">
        <div className="text-left">
          <div className="space-y-4">
            <Title size="black" weight="bold" color="gradient_b">
              Nikmati Live Chat <br />
              Dengan Banyak
              <br /> Fitur Menarik
            </Title>
          </div>
          <div className="flex flex-col md:flex-row mt-14 items-center md:items-start space-y-4 md:space-y-0 md:space-x-14">
            <button onClick={handleSignupButton} className="bg-gradient-to-r from-blue-600 to-purple-700 hover:bg-purple-700 text-white font-bold py-2 rounded-full w-full md:w-44">
              Daftar Sekarang
            </button>
            <button onClick={handleLoginButton} className="border-2 border-purple-600 hover:bg-purple-100 text-purple-600 font-bold py-2 rounded-full w-full md:w-44">
              Masuk
            </button>
          </div>
        </div>
